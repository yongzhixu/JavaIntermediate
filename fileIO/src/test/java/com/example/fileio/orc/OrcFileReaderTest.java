...
class OrcFileReaderTest {
    ...
    @Test
    void readOrcUsingSpark() throws Exception {
        OrcFileReader orcFileReader = new OrcFileReader();
        orcFileReader.readOrcUsingSpark("D:\\Workspace\\Convertlab\\Projects\\quanmian\\purcotton-etl\\tmp\\orc\\data_jumble_zip.orc\\20220715");
//        orcFileReader.readOrcUsingSpark("test-data/0621/test/crm_customer_offline");
    }
}