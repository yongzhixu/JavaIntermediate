...
public class OrcFileWriter {
    ...
    public void write(Configuration configuration, String path, String struct, List<Map<String, Object>> data) throws IOException {
    ...
    public  void writeOrcGeneric(Configuration configuration, String path, String struct, List<Map<String, Object>> data) throws IOException {
        // Create the schemas and extract metadata from the schema
        TypeDescription schema = TypeDescription.fromString(struct);
    ...
    public BiConsumer<Integer, Object> createColumnWriter(TypeDescription description, ColumnVector columnVector) {
