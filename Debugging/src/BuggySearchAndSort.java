...
//				return false;
	 ...
	 * simply sweeps through the array, exchanging neighboring elements that are out
	 * of order. The number of times that it does this is equal to the length of the
	 * array.
	 */
...
//			for (int j = 0; j < array.length-1; i++) {
	...
	/**
	 * Sorts an array into non-decreasing order. This method uses a selection sort
	 * algorithm, in which the largest item is found and placed at the end of the
	 * list, then the second-largest in the next to last place, and so on.
	 */
...
//			array[pos] = temp; // place temp into last vacated position
	...
	/**
	 * Outputs the ints in an array on one line, separated by spaces, with a line
	 * feed at the end.
	 */
